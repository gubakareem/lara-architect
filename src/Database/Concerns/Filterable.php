...
/**
 * Adds a `filter()` scope that applies a ArchitectQueryFilter to the model's query:
 *
...
trait Filterable
{
     ...
     */
    public function scopeFilter(Builder $query, ArchitectQueryFilter $filter): Builder
    {
